...
curl -s -X POST http://localhost:8080/api/versions -H "Content-Type: application/json" -d '{"versionNumber":"7.1EventsAndAlerts","productId":1}' > /dev/null

# Read and Process JSON File
JSON_FILE="7.1EventsandAlerts.json"
